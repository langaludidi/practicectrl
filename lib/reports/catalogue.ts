...
export const REPORT_DEFINITIONS: readonly ReportDefinition[] = [
  ...
  // External Doctors
  { id:"referring-provider-invoices",category:"External Doctors",legacyName:"Invoices From Referring Provider",practiceCtrlName:"Referring-provider activity",description:"Trace referring-provider relationships into encounters, authorisations and related invoice activity.",href:"/authorisations?view=referring-providers",surface:"Report table",detailKind:"referrals",roles:["practitioner","billing","finance","practice_manager","clinical_admin","auditor","system_admin"] },

  // Financial Age Analysis
  { id:"age-combined",category:"Financial Age Analysis",legacyName:"Age Analysis Combined Scheme & Patient",practiceCtrlName:"Combined debtor ageing",description:"Combined scheme and patient outstanding balances with liability separation.",href:"/revenue?view=ageing&liability=combined",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"age-combined-credit",category:"Financial Age Analysis",legacyName:"Age Analysis Combined Scheme & Patient (Only Credit Totals)",practiceCtrlName:"Credit-balance ageing",description:"Show credit balances only across scheme and patient accounts.",href:"/revenue?view=ageing&balance=credit",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"age-combined-debit",category:"Financial Age Analysis",legacyName:"Age Analysis Combined Scheme & Patient (Only Debit Totals)",practiceCtrlName:"Debit-balance ageing",description:"Show debit/outstanding balances only across scheme and patient accounts.",href:"/revenue?view=ageing&balance=debit",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"age-by-account",category:"Financial Age Analysis",legacyName:"Age Analysis Combined Scheme & Patient (Sorted by AccNo)",practiceCtrlName:"Ageing by account",description:"Ageing view sorted/grouped by account reference.",href:"/revenue?view=ageing&sort=account",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"age-by-file",category:"Financial Age Analysis",legacyName:"Age Analysis Combined Scheme & Patient (Sorted by FileNo)",practiceCtrlName:"Ageing by patient/file reference",description:"Ageing view sorted/grouped by patient or legacy file reference where imported.",href:"/revenue?view=ageing&sort=file",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"age-patient-liable",category:"Financial Age Analysis",legacyName:"Age Analysis for Patient Liable",practiceCtrlName:"Patient-liability ageing",description:"Outstanding verified patient-responsibility balances with recovery state.",href:"/revenue?view=ageing&liability=patient",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"age-scheme-liable",category:"Financial Age Analysis",legacyName:"Age Analysis for Scheme Liable",practiceCtrlName:"Scheme-liability ageing",description:"Outstanding scheme-responsibility balances linked to claims and remittances.",href:"/revenue?view=ageing&liability=scheme",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"age-summary",category:"Financial Age Analysis",legacyName:"Age Analysis summary",practiceCtrlName:"Ageing summary",description:"Summary ageing by liability type, age bucket and outstanding value.",href:"/revenue?view=ageing&summary=1",surface:"Report table",detailKind:"ageing",roles:FIN },

  // Financial Generic
  { id:"accounts-credit",category:"Financial Generic",legacyName:"Accounts in Credit",practiceCtrlName:"Credit balances",description:"Identify patient or scheme accounts with net credit balances.",href:"/revenue?view=credit-balances",surface:"Report table",detailKind:"ageing",roles:FIN },
  { id:"credit-note-report",category:"Financial Generic",legacyName:"Credit Note Report",practiceCtrlName:"Credit-note activity",description:"Review credit notes and their relationship to invoices, balances and adjustments.",href:"/billing?view=credit-notes",surface:"Report table",detailKind:"credit-notes",roles:FIN },
  ...
  { id:"invoice-activity",category:"Financial Generic",legacyName:"Invoice Activity",practiceCtrlName:"Invoice activity",description:"Invoice creation, finalisation, status and amount activity.",href:"/billing?view=invoice-activity",surface:"Report table",detailKind:"invoices",roles:FIN },
  { id:"invoice-activity-schemes",category:"Financial Generic",legacyName:"Invoice Activity for Schemes",practiceCtrlName:"Invoice activity by payer",description:"Invoice and expected-revenue activity sliced by medical scheme and plan.",href:"/economics?dimension=scheme",surface:"Report table",detailKind:"invoices",roles:FIN },
  { id:"invoice-detail",category:"Financial Generic",legacyName:"Invoice Detail",practiceCtrlName:"Invoice detail",description:"Open invoice headers, payer resolution, patient liability and line-level detail.",href:"/billing?view=invoices",surface:"Report table",detailKind:"invoices",roles:FIN },
  ...
  { id:"invoice-line-detail",category:"Financial Generic",legacyName:"Invoice Line Detail",practiceCtrlName:"Claim-line economics",description:"Line-level procedure, modifier, diagnosis, tariff, expected and realised reimbursement detail.",href:"/economics?dimension=procedure",surface:"Report table",detailKind:"invoice-lines",roles:FIN },
  { id:"credit-not-reinvoiced",category:"Financial Generic",legacyName:"Invoices with Credit Notes not Invoiced Again",practiceCtrlName:"Credit-note follow-up exceptions",description:"Surface credited invoices without a corresponding corrected/replacement billing outcome.",href:"/billing?view=credit-note-followup",surface:"Report table",detailKind:"credit-notes",roles:FIN_EDIT },
  { id:"journal-activity",category:"Financial Generic",legacyName:"Journal Activity",practiceCtrlName:"Financial audit activity",description:"Trace billing, payment, adjustment and recovery events through immutable audit history.",href:"/audit?entity=billing",surface:"Report table",detailKind:"ledger",roles:FIN },
  { id:"outstanding-invoices",category:"Financial Generic",legacyName:"Outstanding Invoices",practiceCtrlName:"Outstanding invoice worklist",description:"Review invoice balances with payer/patient liability, ageing and recovery state.",href:"/revenue?view=outstanding-invoices",surface:"Report table",detailKind:"invoices",roles:FIN },
  { id:"proforma-line",category:"Financial Generic",legacyName:"Pro forma (only) Line Detail",practiceCtrlName:"Draft invoice line detail",description:"Review unfinalised/pro forma billing lines before invoice finalisation.",href:"/billing?view=proforma-lines",surface:"Report table",detailKind:"quotes",roles:FIN },
  { id:"proforma-activity",category:"Financial Generic",legacyName:"Pro forma Activity",practiceCtrlName:"Draft billing activity",description:"Review pro forma/draft invoice activity and progression to final invoice.",href:"/billing?view=proforma",surface:"Report table",detailKind:"quotes",roles:FIN },
  { id:"proforma-uncommitted",category:"Financial Generic",legacyName:"Pro forma’s Not Committed",practiceCtrlName:"Uncommitted billing drafts",description:"Find draft/pro forma billing that has not been finalised or deliberately cancelled.",href:"/billing?view=uncommitted-proforma",surface:"Report table",detailKind:"quotes",roles:FIN_EDIT },
  { id:"scheme-credit",category:"Financial Generic",legacyName:"Scheme Credit Report",practiceCtrlName:"Scheme credit balances",description:"Review payer/scheme credit balances and reconciliation exceptions.",href:"/revenue?view=scheme-credit",surface:"Report table",detailKind:"scheme-credits",roles:FIN },
  { id:"tax-invoice",category:"Financial Generic",legacyName:"Tax Invoice",practiceCtrlName:"Finalised tax invoices",description:"Access finalised invoice records and printable tax-invoice detail where configured.",href:"/billing?view=tax-invoices",surface:"Report table",detailKind:"vat",roles:FIN },
  ...
  { id:"financial-refunds",category:"Financial Payments (Refunded)",legacyName:"Financial Payments (Refunded)",practiceCtrlName:"Refund and reversal activity",description:"Review payment reversals, refunds and resulting balances through revenue and audit views.",href:"/revenue?view=refunds",surface:"Report table",detailKind:"receipts",roles:FIN },
  { id:"financial-receipts",category:"Financial Receipts (Received)",legacyName:"Financial Receipts (Received)",practiceCtrlName:"Receipt and remittance activity",description:"Review scheme remittances, patient receipts and payment allocations.",href:"/claims?view=receipts",surface:"Report table",detailKind:"receipts",roles:FIN },
  { id:"financial-vat",category:"Financial VAT",legacyName:"Financial VAT",practiceCtrlName:"VAT/tax invoice activity",description:"Review tax-bearing invoice records and VAT-relevant billing fields where the practice configuration requires them.",href:"/billing?view=vat",surface:"Report table",detailKind:"vat",roles:FIN },
